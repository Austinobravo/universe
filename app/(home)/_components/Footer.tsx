    ...
    return (
        <>
            <section className="dark:bg-black dark:text-white px-10 space-y-10">
                <div className="flex items-center flex-wrap md:flex-nowrap p-10 space-y-4 justify-between border-slate-800 border-y-2">
                    <div className="">
                    ...
                    <div>
                        <form>
                            ...
                            <button type="submit" className="px-3 py-1 rounded-md font-bold text-white  bg-amber-400">Subscribe</button>
                        </form>
                    </div>
                </div>
