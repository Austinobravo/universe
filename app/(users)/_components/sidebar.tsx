"use client"
import { BusIcon, ChevronDown, Currency, LayoutDashboard, Menu, Ticket, User } from 'lucide-react'
  ...
  return (
    ...
    <section>
        <div className='h-[55rem] shadow-2xl bg-white w-60 border-r-2'>
            <div className='flex  border-b-2 items-center space-x-2 py-4'>
                <Menu size={35}/>
